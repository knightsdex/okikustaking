...
const InfoCard = ({ disabled, label, value, stakeAction, viewDetail, balance, showPositions }: any) => {
    ...
    const getHint = () => {
        switch (label) {
            case "position":
                return "Your positions of OKIKU tokens based in your total staked amount and staking duration.";
            case "stake":
                return "Total balance of your wallet";
            case "canstake":
                return "Your available amount of OKIKU to stake. It is just your wallet balance of OKIKU";
            case "canunstake":
                return "Your available amount of OKIKU to unstake. It is just amount of your staked OKIKU tokens";
            default:
                return "Coming soon !";
        }
    }
