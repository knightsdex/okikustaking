...
import avatar3 from '../assets/img/08/svg-export-3x.png';
    ...
    return (
        <>
                                ...
                                <div className="flex flex-col md:flex-row gap-6 text-sm text-[#A3A3A3] relative">
                                    ...
                                    <div className="flex flex-col md:w-1/2 gap-2 font-semibold text-[#FAFAFA] relative z-10">
                                        <div className="flex flex-col">
                                            ...
                                            <p className="dark:text-[#004450]">If you stake 1,000 OKIKU tokens for 30 days on June 10th at 2:00 PM, here's what happens:<br></br>Stake Date: June 10th, 2:00 PM<br></br>Lock Period Ends: July 10th, 2:00 PM (exactly 30 days later)<br></br>Your Reward: 57 OKIKU tokens (1,000 × 30 days × 0.19% = 57 OKIKU)<br></br>Total When Unstaking: 1,057 OKIKU tokens</p>
                                        </div>
                                    </div>
                                </div>
                                <div className="absolute left-[40%] -translate-x-1/2 top-1/2 -translate-y-1/2">
                                    <img 
                                        src={avatar3} 
                                        alt="avatar" 
                                        className="w-24 h-24 md:w-32 md:h-40 object-cover opacity-80"
                                    />
                                </div>
                            </div>
                        </div>
            ...
            <Modal isOpen={modalStatus} onClose={handleCloseModal}>
                <h2 className="text-xl font-semibold text-primary">{activeTab === 'stake' ? 'Stake OKIKU' : 'Unstake OKIKU'}</h2>
                ...
                <div className="flex flex-col w-full gap-1">
                    ...
                    <div className="flex flex-row items-center justify-between border border-[#5b5b5b] rounded-lg pr-4 bg-card-bg">
                        ...
                        <div className="flex flex-row gap-2 items-center">
                            <div className="text-primary">OKIKU</div>
                ...
                </div>
                {
                    data.address ?
                        <button className={`rounded-3xl py-2 px-4 text-[16px] bg-[#fff533] text-black hover:text-[#5b5b5b] font-bold flex flex-row items-center justify-center gap-1 w-max`} onClick={handleStake}>
                            <div>
                                {activeTab === 'stake' ? 'Stake OKIKU' : 'Unstake OKIKU'}
                            </div>
                        </button> :
