                ...
                <div className='md:py-[80px] py-[30px] flex lg:flex-row flex-col lg:gap-[8vw] gap-8 w-full'>
                    <div className='flex flex-col justify-between lg:w-[50%] w-full space-y-12'>
                        <div className='space-y-4'>
                            ...
                            <div className='text-[#A3A3A3]'>Be the first to hear about exclusive offers and the latest updates from OKIKU.</div>
                    ...
                    <div className='flex flex-col justify-between lg:w-[50%] w-full space-y-12'>
                        <div className='space-y-6'>
                            ...
                            <div className='flex flex-row md:gap-6 justify-between md:justify-start'>
                                <a href="https://x.com/OKIKUERC/" target="_blank" rel="noopener noreferrer">
                                    <img src={X_icon} alt='social-icon' />
                                </a>
                                <a href="https://t.me/OKIKUERC" target="_blank" rel="noopener noreferrer">
                                    <img src={Telegram_icon} alt='social-icon' />
                                </a>
                            </div>
                            <div className='text-[#A3A3A3]'>© 2026 OKIKU All rights reserved.</div>
                        </div>
                    </div>
                </div>
            </div>
