...
const faqData: FaqItem[] = [
    ...
    {
        question: 'What can I use my OKIKU for?',
        answer: 'You can use your OKIKU to participate in staking, governance, or trading within the ecosystem.'
    },
    {
        question: 'How do I earn OKIKU by staking OKIKU, and what is the maximum I can earn?',
        answer: 'By staking your OKIKU, you earn additional OKIKU based on the staking contract’s rewards rate. The maximum you can earn depends on the staking terms.'
    }
];
