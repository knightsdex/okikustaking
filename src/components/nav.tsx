...
// import whitemark from '../assets/img/watermark.png';
// import darkmark from '../assets/img/watermark1.png';
import tokenABI from '../utils/abis/token.json';

import Logo_white from "../assets/img/08/logo.png";
...
const Nav: React.FC = () => {
	...
	return (
		<header className="flex flex-col fixed top-0 z-[50] text-primary bg-[#FAFAFA] dark:bg-[#004450] w-full">
			...
			{isMenuOpen && (
				<div className="absolute top-[60px] left-0 w-full bg-primary-bg z-50 h-[calc(100vh-60px)] flex flex-col justify-between py-8 px-4">
					<nav className="flex flex-col space-y-6 pb-8">
						<div className="text-xl">Stake OKIKU</div>
						<Link
							to="/"
					...
					<div className="w-full flex flex-col justify-center gap-8">
						<div className={`px-8 py-4 h-[76px] rounded-xl  flex flex-row gap-4 bg-card-bg`}>
							...
							<div className="flex flex-col">
								<div className=" text-lg font-bold">{shortNumber(balance)} OKIKU</div>
