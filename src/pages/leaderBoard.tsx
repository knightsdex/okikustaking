                    ...
                    <>
                        ...
                        <div className="space-y-1 max-h-96 overflow-y-auto">
                            {positions.map((position, index) => (
                                <div 
                                    key={index} 
                                    onClick={!position.withdrawn ? () => handleRowClick(position.id, position) : undefined}
                                    className={`rounded-lg transition-colors ${!position.withdrawn ? 'hover:bg-slate-800/40 cursor-pointer' : 'cursor-not-allowed opacity-60'}`}
                                >
                                    <div className="grid grid-cols-12 gap-4 px-4 py-4 text-white">
                                        ...
                                        <div className="col-span-2 flex items-center">
                                            {formatNumber(position.amount)} OKIKU
                                        </div>
                                        <div className="col-span-2 flex items-center text-emerald-400">
                                            {formatNumber(position.reward)} OKIKU
                                        </div>
...
const LeaderBoard: React.FC = () => {
    ...
    return (
        <div className="bg-[#00e0ff] dark:bg-[#FCA311] relative z-[10]">
