...
//                                         </span>
//                                         <span className="md:w-2/12 w-2/12">
//                                             {shortNumber(Number(tx.amount) / 10 ** 18)} OKIKU
//                                         </span>
//                                     </div>
//                                 ))}
//                             </div>
        ...
        <div className="bg-[#00e0ff] dark:bg-[#FCA311] relative z-[10]">
            <div className="w-full 2xl:w-[1280px] 2xl:mx-auto md:px-8 2xl:px-0 px-4 pb-[150px]">
                ...
                <div className="relative w-full md:pt-[80px] pt-[30px]">
                    {/* Content */}
                    <div className="relative flex flex-col items-center min-h-lvh text-white pt-20 gap-3">
                        <div className="text-3xl xl:text-5xl lg:text-4xl md:text-2xl mt-3 lg:w-[95%] w-full text-[#FCA311] dark:text-[#4DF6DD] font-semibold text-center pb-16">
                            Staking Overview
                        </div>
                        <TransactionTable />
                    </div>
